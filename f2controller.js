...
$.extend(Controller, {
  ...
  setDefaultStartEndPos: function () {
    ...
    for (var i = 0; i < f2blockarray.length; i++) {
      this.setWalkableAt.apply(this, f2blockarray[i]);
    }
    ...
    $("#Search_bt").click(function () {
      ...
      if (x == "202") {
        Controller.setEndPos(37, 17);
      } else if (x == "203") {
        Controller.setEndPos(34, 17);
      } else if (x == "204") {
        Controller.setEndPos(30, 17);
      } else if (x == "205") {
        Controller.setEndPos(27, 17);
      } else if (x == "208") {
        Controller.setEndPos(30, 20);
      } else if (x == "211") {
        Controller.setEndPos(22, 46);
      } else if (x == "212") {
        Controller.setEndPos(26, 46);
      } else if (x == "213") {
        Controller.setEndPos(30, 46);
      } else if (x == "214") {
        Controller.setEndPos(40, 47);
      } else if (x == "215") {
        Controller.setEndPos(43, 47);
      } else if (x == "216") {
        Controller.setEndPos(43, 39);
      } else if (x == "217") {
        Controller.setEndPos(41, 39);
      } else if (x == "218") {
        Controller.setEndPos(45, 32);
      } else if (x == "219") {
        Controller.setEndPos(45, 28);
      } else if (x == "220") {
        Controller.setEndPos(45, 23);
      } else if (x == "221") {
        Controller.setEndPos(37, 20);
      } else if (x == "222") {
        Controller.setEndPos(41, 20);
      } else if (x == "223") {
        Controller.setEndPos(45, 20);
      } else {
        alert(
