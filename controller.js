...
$.extend(Controller, {
  ...
  setDefaultStartEndPos: function () {
    ...
    // set block point //
    for (var i = 0; i < b1blockarray.length; i++) {
      this.setWalkableAt.apply(this, b1blockarray[i]);
    }

    $("#draw_area").click(function () {
      var coord = View.toPageCoordinate(this.gridX, this.gridY);
      if (coord.isStartOrEndPos == false) {
        var target = document.querySelector(".set_point");
        target.style.display = "flex";
        $("#startp").click(function () {
          var x = coord.gridX;
          var y = coord.gridY;
          Controller.setStartPos(x, y);
          target.style.display = "none";
        });
        $("endp").click(function () {
          var x = coord.gridX;
          var y = coord.gridY;
          Controller.setEndPos(x, y);
          target.style.display = "none";
        });
      }
    });
    ...
    $("#Search_bt").click(function () {
      ...
      if (x == "B126") {
        Controller.setEndPos(19, 44);
      } else if (x == "B102") {
        Controller.setEndPos(46, 16);
      } else if (x == "B101") {
        Controller.setEndPos(46, 26);
      } else if (x == "B107") {
        Controller.setEndPos(33, 19);
      } else if (x == "B108") {
        Controller.setEndPos(30, 19);
      } else if (x == "B109") {
        Controller.setEndPos(28, 19);
      } else if (x == "B110") {
        Controller.setEndPos(25, 19);
      } else if (x == "B117") {
        Controller.setEndPos(22, 19);
      } else if (x == "B111") {
        Controller.setEndPos(34, 24);
      } else if (x == "B112") {
        Controller.setEndPos(34, 26);
      } else if (x == "B113") {
        Controller.setEndPos(28, 30);
      } else if (x == "B114") {
        Controller.setEndPos(25, 21);
      } else if (x == "B115") {
        Controller.setEndPos(21, 24);
      } else if (x == "B116") {
        Controller.setEndPos(21, 28);
      } else if (x == "B118") {
        Controller.setEndPos(19, 21);
      } else if (x == "B119") {
        Controller.setEndPos(19, 24);
      } else if (x == "B120") {
        Controller.setEndPos(19, 27);
      } else if (x == "B121") {
        Controller.setEndPos(19, 30);
      } else if (x == "B122") {
        Controller.setEndPos(19, 33);
      } else if (x == "B123") {
        Controller.setEndPos(19, 35);
      } else if (x == "B124") {
        Controller.setEndPos(19, 38);
      } else if (x == "B125") {
        Controller.setEndPos(19, 41);
      } else if (x == "B129") {
        Controller.setEndPos(20, 57);
      } else if (x == "B130") {
        Controller.setEndPos(21, 58);
      } else if (x == "B132") {
        Controller.setEndPos(16, 61);
      } else if (x == "B133") {
        Controller.setEndPos(19, 67);
      } else if (x == "B134") {
        Controller.setEndPos(26, 64);
      } else if (x == "B135") {
        Controller.setEndPos(29, 61);
      } else if (x == "B140") {
        Controller.setEndPos(49, 42);
      } else if (x == "B142") {
        Controller.setEndPos(49, 39);
      } else if (x == "B141") {
        Controller.setEndPos(52, 36);
      } else if (x == "B139") {
        Controller.setEndPos(52, 45);
      } else {
        alert(
    ...
    /*if ($("rect").isStartOrEndPos(gridX, gridY)) {
      $("rect").draggable();
    }*/

    $("grid").click(function () {
      var target = ducument.querySelector(".set_point");
      target.style.display = "flex";
    });
  },
