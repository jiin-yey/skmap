...
$.extend(Controller, {
  ...
  setDefaultStartEndPos: function () {
    ...
    for (var i = 0; i < f5blockarray.length; i++) {
      this.setWalkableAt.apply(this, f5blockarray[i]);
    }
    ...
    $("#Search_bt").click(function () {
      ...
      if (x == "518") {
        Controller.setEndPos(40, 12);
      } else if (x == "520") {
        Controller.setEndPos(32, 19);
      } else if (x == "521") {
        Controller.setEndPos(32, 29);
      } else if (x == "522") {
        Controller.setEndPos(32, 39);
      } else if (x == "517") {
        Controller.setEndPos(42, 19);
      } else if (x == "516") {
        Controller.setEndPos(42, 23);
      } else if (x == "515") {
        Controller.setEndPos(42, 25);
      } else if (x == "514") {
        Controller.setEndPos(38, 37);
      } else if (x == "504") {
        Controller.setEndPos(8, 51);
      } else if (x == "503") {
        Controller.setEndPos(15, 49);
      } else if (x == "502") {
        Controller.setEndPos(20, 49);
      } else if (x == "501") {
        Controller.setEndPos(22, 49);
      } else if (x == "513") {
        Controller.setEndPos(38, 53);
      } else if (x == "512") {
        Controller.setEndPos(34, 60);
      } else if (x == "511") {
        Controller.setEndPos(31, 61);
      } else if (x == "510") {
        Controller.setEndPos(27, 64);
      } else if (x == "509") {
        Controller.setEndPos(25, 64);
      } else if (x == "508") {
        Controller.setEndPos(21, 64);
      } else if (x == "507") {
        Controller.setEndPos(19, 64);
      } else if (x == "506") {
        Controller.setEndPos(11, 61);
      } else if (x == "505") {
        Controller.setEndPos(9, 61);
      } else {
        alert(
